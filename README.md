...
- Δημιουργία συνάρτησης image_conv που θα παίρνει ως ορίσματα μια εικόνα $f$ και ένα φίλτρο $w$ και θα πραγματοποιεί συνέλιξη μεταξύ $f$ και $w$.
  ...
  - Δημιουργία συνάρτησης padding που θα παίρνει ως όρισμα την NxN εικόνα και θα επιστρέφει (N+1)x(N+1) εικόνα με μηδενικά στις νέες θέσεις του πίνακα (zero padding)
